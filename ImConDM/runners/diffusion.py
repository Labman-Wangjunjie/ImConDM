    ...
    def sample_sequence(self, model, ts, mind):
        ...
        with torch.no_grad():
            ...
            if (args.dataset == 'SMAP'):
                ...
                testdata = np.loadtxt('./data/SMD2/test/machine-1-1.txt', delimiter=',')

                label = np.loadtxt('./data/SMD2/test_label/machine-1-1.txt', delimiter=',')
            elif (args.dataset == 'WADI'):
            ...
            metrics_calculate(real_data, re_datas, label,masks, mind, ts)
